...
export default function Productos() {
  ...
  const [paginaActual, setPaginaActual] = useState(1);
    ...
    updateMetaTag('description', 'Encontra aqui los mejores productos de linea blanca, 100% Made in Argentina.');
    updateMetaTag('keywords', 'anafes, calefones, cocinas, hornos, termotanques');
    updateMetaTag('author', '@webmaster');
    updateMetaTag('robots', 'index, follow');

    // Open Graph

    updateMetaTag('og:title', 'VOLCAN ON-LINE', 'property');
    updateMetaTag('og:description', 'Encontra aqui los mejores productos linea blanca.', 'property');
    updateMetaTag('og:type', 'website', 'property');
    updateMetaTag('og:image', 'https://tudominio.com/logo.jpg', 'property');/*corregir*/
