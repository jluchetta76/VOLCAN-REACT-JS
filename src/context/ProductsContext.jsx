...
export const ProductsProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    const cargarProductos = async () => {
      ...
      try {
        ...
        const respuesta = await fetch('https://68d97f0790a75154f0da8a06.mockapi.io/api/productos');
  ...
  const editarProducto = async (productoActualizado) => {
    ...
    try {
      ...
      const respuesta = await fetch(`https://68d97f0790a75154f0da8a06.mockapi.io/api/productos/${productoActualizado.id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
